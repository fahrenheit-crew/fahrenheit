...
/// <summary>Possible directions for the active character to change in.</summary>
public enum SphereGridChangeDirection : byte {
    /// <summary>No character change is occuring right now.</summary>
    NONE,

    /// <summary>The current character is switching to the next one on the left.</summary>
    LEFT,

    /// <summary>The current character is switching to the next one on the right.</summary>
    RIGHT,
}
...
public unsafe struct LpAbilityMapEngine {
    ...
    [InlineArray(7)]
    public struct SphereGridPlyInfoArray {
        private SphereGridPlyInfo _data;
    }
    ...
    [FieldOffset(0x11088)] public SphereGridPlyInfoArray        party_infos;
    ...
    [FieldOffset(0x115A8)] public void* fn_ctrl;
    [FieldOffset(0x115AC)] public void* fn_help;
    [FieldOffset(0x115B0)] public void* fn_ctrl_backup;
    [FieldOffset(0x115B4)] public void* fn_help_backup;

    [FieldOffset(0x115B8)] public byte fade_timer;
    [FieldOffset(0x115B9)] public byte __0x115B9;

    [FieldOffset(0x115BC)] public byte current_ply_id;
    [FieldOffset(0x115BD)] public byte previous_ply_id;

    [FieldOffset(0x115BE)] public SphereGridChangeDirection ply_change_dir;
